#!/usr/bin/env python3
"""
Главный файл бота для деплоя на Beget
"""
...
# Настройка логирования для Beget
logger = setup_logger("dating_bot", "INFO")

async def main():
    """Главная функция запуска бота"""
    log_bot_event(logger, "Bot startup", "Starting dating bot on Beget...")
    ...
    logger.info("Бот запущен и готов к работе на Beget!")
